...
/// ```no_run
/// use clap::Command;
/// use uudiff::clap_localization::handle_clap_result;
///
...
/// ```no_run
/// use clap::Command;
/// use uudiff::clap_localization::handle_clap_result_with_exit_code;
///
/// let cmd = Command::new("myutil");
...
/// ```no_run
/// use clap::Command;
/// use uudiff::clap_localization::handle_clap_error_with_exit_code;
///
/// let cmd = Command::new("myutil");
...
/// ```no_run
/// use clap::Command;
/// use uudiff::clap_localization::configure_localized_command;
///
/// let cmd = Command::new("myutil")
